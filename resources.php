      ...
      <div class="row p-3-vh">
         ...
         <div class="col-md-3 wow-outer">
            <div class="blogcolumn wow slideInRight"  data-wow-delay=".3s">
               ...
               <div class="blogcont">
                  <div class="headingblog">
                     <a href="https://sokodirectory.com/2023/06/esther-ngomeli-exits-redhouse-establishes-zenith-east-africa-group/" target="_blank">Esther Ngomeli exits Redhouse Group to establish Zenith East
Africa Group</a>
                  </div>
               </div>
            </div>
